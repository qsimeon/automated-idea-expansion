...
- **Code Creator** (`code-creator-v2.ts`): 5-stage pipeline with iteration
...
| `src/lib/agents/creators/code/code-creator-v2.ts` | Code pipeline | ~500 |
